...
/**
 * Servlet implementation class wr_tableSelect
 */
@WebServlet("/servlet/wr_tableSelect")
public class wr_tableSelect extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public wr_tableSelect() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		List<Map<String,String>> map =w.getworkSheetsById(wsid);
		request.setAttribute("workList", map);
