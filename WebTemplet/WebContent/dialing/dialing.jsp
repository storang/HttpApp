...
<script src="dialing/dialingjs/dialing.js"></script>
</head>
<body id="nav" class="workorder">
<script>
</script>
	...
	<div class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-2 main">	
		...
		<div class="row">
			<div class="col-lg-12">
				<h1 class="page-header">主叫显示查询</h1>
			</div>
		</div><!--/.row-->
		<!-- 页面主题结束 -->		
		<div class="row">
						...
						<!-- 数据表格开始 -->
						 ...
						 表格工具条开始-->
						    <div class="fixed-table-toolbar"> 
						    	...
						    	&nbsp;&nbsp;&nbsp;&nbsp;查询&nbsp;&nbsp;&nbsp;&nbsp;国家&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;:<input class="layui-input" type="text" placeholder="请输入国家" style="width: 400px;" name="country" id="countryId" list="mbCountry"><br>
						    	可开通主叫运营商为:<input class="layui-input" type="text"  style="width: 400px;" id="win2" onfocus="this.blur()">
						    	&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
						    	</div>
						        <!-- <ul id="colors_ul"></ul> -->
						         <!-- datalist
						        ...
						        <div class="columns btn-group pull-left">
						        	<button class="btn btn-default" type="button" name="Search" title="Search" id="submitId" onclick="selectServe()"><i class="glyphicon glyphicon-search"></i></button>
						        </div>
					</div>
				</div>
			</div>
