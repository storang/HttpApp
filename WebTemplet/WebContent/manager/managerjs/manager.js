 ...
 */
 ...
 function getUserByPageNum(page){
 	$.post("servlet/pageManager",{"pageNum":page,"pageSize":pageSize},fillTable,"json");
 }
 function fillTable(data){
	...
	$.each(data.list,function(){
		var trHtml = "<tr><td class='bs-checkbox'><input type='checkbox' name='test' value="+this.mirid+"></td><td>"+this.country+"</td><td>"+this.mm_code+"</td>" +
				...
				"<a class='glyphicon glyphicon-list-alt action-button' href='manager/managerSelf.jsp?id="+this.mirid+"'></a>" +
